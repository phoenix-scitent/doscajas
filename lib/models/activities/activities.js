...
Schemas.Activity = new SimpleSchema({
  ...
  attempt: {
    ...
    'attempt.topic_stats': {
      type: Object, // copy of full BOK, for each level cache scores based on measure/resource tags...
      optional: true,
      blackbox: true
    },
    'attempt.items': {
  ...
  items: {
    ...
    //TODO: we handle positioning outside of the DB via activity_attempt.js (measures template helper), is this necessary?
    //'items.$.position': {
    //  type: Number,
