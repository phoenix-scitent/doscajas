Sequences = new Mongo.Collection('sequences', {
  transform: function(sequenceDoc){

    if(sequenceDoc.attempt){
      sequenceDoc.attempt.items = _.map(sequenceDoc.attempt.items, function(item, i){
        item.position = i+1;
        return item;
      });
    }
...
//
//  Eric, i stuck the meteor methods in sequences_methods.js
//  this file got too big... ;)
//