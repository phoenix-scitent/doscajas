Template.activity_attempt.helpers({
  cajas: function() {
...
Template.activity_attempt.rendered = function(){
...
Template.activity_attempt.events({
  ...
  'click #dashboard-button': function(event){
    var activity_id = $(event.target).data('id');

    Router.go('/begin_activity/' + activity_id)
  },
